...
import com.rodsilca.springboot_social_posts_api.dto.CommentDTO;
...
public class Instantiation implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Post post1 = new Post(null, sdf.parse("21/03/2025"),"Vou de Viagem", "Vou viajar", new AuthorDTO(maria));
		...
		CommentDTO c3 = new CommentDTO("tenha um otimo dia",sdf.parse("21/03/2025"), new AuthorDTO(alex));
